...
- pwsh .commanding/ps1/repo-map-builder.ps1 -MakeZip -OutFile report/slice/repo-map.md -ZipFile
  report/slice/full-slice.zip -IncludeFiles

Delta slice (git base..head)

- pwsh .commanding/ps1/delta-slice-builder.ps1 -BaseRef origin/master -HeadRef HEAD -IncludeUntracked -OutDir
  report/slice -WriteMap

What to send to ChatGPT

- First time (or large refactor): full-slice.zip + report/slice/repo-map.md + slice-manifest (if you generated it
  separately)
