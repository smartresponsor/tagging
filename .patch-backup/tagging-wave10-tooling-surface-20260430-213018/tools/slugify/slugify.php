...
use App\Tagging\Service\Core\Slug\{TagSlugifier, TagSlugPolicy};
...
$slugifier = new TagSlugifier((bool) (($cfg['lowercase'] ?? true)), (int) ($cfg['max_length'] ?? 64));
$policy = new TagSlugPolicy($pdo, $slugifier, $reserved, (int) ($cfg['max_length'] ?? 64));
