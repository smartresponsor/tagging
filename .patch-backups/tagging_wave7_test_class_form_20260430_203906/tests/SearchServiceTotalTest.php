...
final class SearchServiceTotalTest extends TestCase
{
    ...
    {
        $service = new TagSearchService($this->readModel(), new TagSearchCache($this->cacheDir('total')));
    ...
    {
        $service = new TagSearchService($this->readModel(), new TagSearchCache($this->cacheDir('cache')));
