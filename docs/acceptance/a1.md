...
$verifier = new App\Tagging\Verifier\Security\TagHmacV2Verifier($cfg['secret'], (int)$cfg['skew_sec']);
$mw = new App\Tagging\Handler\Http\TagVerifySignatureMiddleware($verifier, $cfg);
