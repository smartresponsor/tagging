...
$verifier = new App\Tagging\Service\Security\TagHmacV2Verifier($cfg['secret'], (int)$cfg['skew_sec']);
$mw = new App\Tagging\Http\Api\Tag\Middleware\TagVerifySignatureMiddleware($verifier, $cfg);
