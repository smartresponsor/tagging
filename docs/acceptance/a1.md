...
$verifier = new App\Tagging\Service\Security\HmacV2Verifier($cfg['secret'], (int)$cfg['skew_sec']);
$mw = new App\Tagging\Http\Api\Tag\Middleware\VerifySignature($verifier, $cfg);
