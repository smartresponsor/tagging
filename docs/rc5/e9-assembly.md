...
1. Создай рабочую папку `bundle/` и распакуй туда содержимое артефактов E2..E8 (сохрани структуру `db/`, `config/`,
   `host-minimal/`, `tools/`, `docs/`).
...
- В `tag-compose.yaml` сервис `tag` монтирует `bundle/` внутрь контейнера в /app.
