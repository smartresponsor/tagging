 ...
 * both legacy host-minimal export keys and FQCN-based route catalog service
 * identifiers alive while delegating controller graphs to Symfony-managed
 * services.
 *
...
return (static function (): array {
    ...
    $container->share(TagController::class, static fn(): object => $symfony->get(TagController::class));
    $container->share(AssignController::class, static fn(): object => $symfony->get(AssignController::class));
    $container->share(SearchController::class, static fn(): object => $symfony->get(SearchController::class));
    $container->share(SuggestController::class, static fn(): object => $symfony->get(SuggestController::class));
    $container->share(AssignmentReadController::class, static fn(): object => $symfony->get(AssignmentReadController::class));
    $container->share(StatusController::class, static fn(): object => $symfony->get(StatusController::class));
    $container->share(SurfaceController::class, static fn(): object => $symfony->get(SurfaceController::class));
    $container->share(TagWebhookController::class, static fn(): object => $symfony->get(TagWebhookController::class));

    $container->share('tagController', static fn(): object => $container->get(TagController::class));
    $container->share('assignController', static fn(): object => $container->get(AssignController::class));
    $container->share('searchController', static fn(): object => $container->get(SearchController::class));
    $container->share('suggestController', static fn(): object => $container->get(SuggestController::class));
    $container->share('assignmentReadController', static fn(): object => $container->get(AssignmentReadController::class));
    $container->share('statusController', static fn(): object => $container->get(StatusController::class));
    $container->share('surfaceController', static fn(): object => $container->get(SurfaceController::class));
    $container->share('webhookController', static fn(): object => $container->get(TagWebhookController::class));
    ...
    return $container->export([
        ...
        'httpPipeline',
        TagController::class,
        AssignController::class,
        SearchController::class,
        SuggestController::class,
        AssignmentReadController::class,
        StatusController::class,
        SurfaceController::class,
        TagWebhookController::class,
        'tagController',
        'assignController',
        'searchController',
        'suggestController',
