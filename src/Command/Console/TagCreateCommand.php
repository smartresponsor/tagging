...
use App\Tagging\Command\Input\TagCreateCommand as CreateTag;
...
final class TagCreateCommand extends TagAbstractCommand
{
    public function __construct(private readonly TagCreateHandlerInterface $useCase)
    {
        parent::__construct();
    }
