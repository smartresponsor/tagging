...
use App\Tagging\Command\Input\TagDeleteCommand as DeleteTag;
...
final class TagDeleteCommand extends TagAbstractCommand
{
    public function __construct(private readonly TagDeleteHandlerInterface $useCase)
    {
        parent::__construct();
    }
