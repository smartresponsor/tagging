...
use App\Tagging\Application\Write\Tag\Dto\TagPatchCommand as PatchTag;
...
final class TagUpdateCommand extends AbstractTagCommand
{
    public function __construct(private readonly TagPatchUseCaseInterface $useCase)
    {
        parent::__construct();
    }
