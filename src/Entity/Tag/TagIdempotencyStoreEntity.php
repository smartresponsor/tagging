...
use App\Tagging\Repository\Core\Tag\TagIdempotencyStoreRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TagIdempotencyStoreRepository::class)]
#[ORM\Table(name: 'idempotency_store')]
final class TagIdempotencyStoreEntity
{
