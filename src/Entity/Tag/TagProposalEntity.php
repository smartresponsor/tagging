...
use App\Tagging\Repository\Core\Tag\TagProposalRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TagProposalRepository::class)]
#[ORM\Table(name: 'tag_proposal')]
#[ORM\Index(name: 'tag_proposal_status_idx', columns: ['tenant', 'status'])]
final class TagProposalEntity
{
