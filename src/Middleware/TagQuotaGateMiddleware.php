...
namespace App\Tagging\Middleware;

use App\Tagging\Responder\Api\TagJsonResponder;
use App\Tagging\Recorder\Metrics\TagMetrics;
use App\Tagging\Service\Core\TagRateLimiter;

final readonly class TagQuotaGateMiddleware
{
    public function __construct(
        private TagRateLimiter $limiter,
        private array $cfg = [],
    ...
    {
        $ignore = $this->cfg['paths']['ignore'] ?? ['/tag/_status', '/tag/_surface', '/tag/_metrics'];
