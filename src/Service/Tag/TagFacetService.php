...
final class TagFacetService
{
    ...
    {
        return $this->repo->facetTop($tenantId, $assignedType, $limit);
    }

    /** @return array<int, array{tagId:string, slug:string, label:string, cnt:int}> */
    public function cloud(string $tenantId, int $limit = 100): array
    {
        return $this->repo->tagCloud($tenantId, $limit);
    }
}
