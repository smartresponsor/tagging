...
final class TagReleaseDisciplineRcTest extends TestCase
{
    public function testCiAndPreflightIncludeReleaseAssetAndOpenApiSemanticsAudits(): void
    {
        ...
        self::assertStringContainsString('audit:generated-openapi-surface', $composer);
        self::assertStringContainsString('docs:openapi:publish', $composer);
        ...
        self::assertStringContainsString('tag-generated-openapi-surface-audit.php', $preflight);
        ...
        self::assertStringContainsString('composer run -n audit:generated-openapi-surface', $ci);
        self::assertStringContainsString('composer run -n docs:openapi:publish', $ci);
        ...
        self::assertStringContainsString('composer run -n audit:generated-openapi-surface', $ciAudit);
    }
    ...
    public function testReleaseWorkflowExistsAndPackagesRcBundle(): void
    {
        ...
        self::assertStringContainsString('composer run -n docs:openapi:publish', $workflow);
        ...
        self::assertStringContainsString('composer run -n audit:generated-openapi-surface', $workflow);
