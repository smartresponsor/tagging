...
use App\Tagging\Http\Api\Tag\TagAssignmentReadController;
...
final class TagSearchSuggestControllerContractTest extends TestCase
{
    public function testSearchControllerReturnsCanonicalTopLevelResponse(): void
    {
        ...
        $controller = new TagSearchController(new TagSearchService($read, new TagSearchCache($baseDir . '/search', 60)));
    ...
    public function testSuggestControllerBlankQueryReturnsEmptyItemsAndNotValidationFailure(): void
    {
        ...
        $controller = new TagSuggestController(new TagSuggestService($read, new TagSuggestCache($baseDir . '/suggest', 60)));
    ...
    public function testAssignmentReadControllerAcceptsCanonicalTenantHeaderCasing(): void
    {
        ...
        $controller = new TagAssignmentReadController($read);
