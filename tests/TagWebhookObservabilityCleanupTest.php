...
use App\Tagging\Http\Api\Tag\Middleware\TagObserveMiddleware;
...
final class TagWebhookObservabilityCleanupTest extends TestCase
{
    ...
    public function testObserveMiddlewareWritesSlowlogForSlowRequests(): void
    {
        ...
        $middleware = new TagObserveMiddleware(['slowlog_path' => $path, 'threshold_ms' => ['read' => 0, 'write' => 0]]);
