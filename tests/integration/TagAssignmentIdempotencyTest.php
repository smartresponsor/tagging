...
final class TagAssignmentIdempotencyTest extends IntegrationDbTestCase
{
    ...
    public function testAssignWithSameIdempotencyKeyAndDifferentPayloadReturnsConflict(): void
    {
        ...
        $first = $service->assign('tenant-idem-conflict', 'tag-idem-conflict', 'product', 'p-1001', 'idem-key-conflict');
        $second = $service->assign('tenant-idem-conflict', 'tag-idem-conflict', 'product', 'p-1002', 'idem-key-conflict');
