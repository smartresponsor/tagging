...
$renamed = [
    'src/Application/Write/Tag/UseCase/CreateTag.php' => 'src/Application/Write/Tag/UseCase/TagCreateHandler.php',
    'src/Application/Write/Tag/UseCase/CreateTagInterface.php' => 'src/Application/Write/Tag/UseCase/TagCreateHandlerInterface.php',
    'src/Application/Write/Tag/UseCase/DeleteTag.php' => 'src/Application/Write/Tag/UseCase/TagDeleteHandler.php',
    'src/Application/Write/Tag/UseCase/DeleteTagInterface.php' => 'src/Application/Write/Tag/UseCase/TagDeleteHandlerInterface.php',
    'src/Application/Write/Tag/UseCase/PatchTag.php' => 'src/Application/Write/Tag/UseCase/TagPatchHandler.php',
    'src/Application/Write/Tag/UseCase/PatchTagInterface.php' => 'src/Application/Write/Tag/UseCase/TagPatchHandlerInterface.php',
...
foreach ($iterator as $item) {
    ...
    if (str_starts_with(substr($path, strlen($root) + 1), 'src/')) {
        $hasNestedTaggingNamespace = str_contains($content, 'namespace App\\Tagging\\');
        $hasRootTaggingNamespace = str_contains($content, 'namespace App\\Tagging;');

        if (!$hasNestedTaggingNamespace && !$hasRootTaggingNamespace) {
