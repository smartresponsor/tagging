...
$checks = [
    ...
    ['CHANGELOG.md', $changelog, 'generated Swagger/OpenAPI surface'],
    ['RELEASE_NOTES.md', $notes, 'prerelease / RC candidate'],
    ['RELEASE_NOTES.md', $notes, 'composer run -n release:preflight'],
    ['RELEASE_NOTES.md', $notes, 'composer run -n audit:generated-openapi-surface'],
    ['docs/public/index.md', $publicIndex, 'docs/ops/runbook.md'],
    ['docs/public/index.md', $publicIndex, 'generated Swagger/OpenAPI surface: `public/tag/openapi/`'],
